                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12 mb-4">
                                            <div class="bg-blue-dark rounded text-center p-3">
                                                <div class="d-inline-block position-relative donut-chart-sale mb-3">
                                                    <span class="donut1"
                                                          data-peity='{ "fill": ["rgb(255, 255, 255)",
                                                          "rgba(255, 255, 255, 0.2)"],"innerRadius": 33,
                                                          "radius": 10}'>{{$investment->currentReturn/$investment->numberOfReturn}}</span>
